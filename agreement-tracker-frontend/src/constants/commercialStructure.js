...
export const PAYMENT_REALIZATION_OPTIONS = [
  { value: PAYMENT_REALIZATION_TYPE.DIRECT_PAYMENT_INVOICE, label: 'Direct Payment / Invoice' },
  { value: PAYMENT_REALIZATION_TYPE.CREDIT_NOTE, label: 'Credit Note' },
  { value: PAYMENT_REALIZATION_TYPE.INVOICE_DISCOUNT, label: 'Invoice Discount' },
];
...
export function deriveHybridFlags(commercialStructure) {
  return {
    enableFlatBaseline: commercialStructure === 'FLAT' || commercialStructure === 'HYBRID',
    enableSlabIncentives: commercialStructure === 'SLAB' || commercialStructure === 'HYBRID',
  };
}
