...
export const ENDPOINTS = {
  ...
  AGREEMENT_UPDATE: (id) => `${BASE}/agreements/${id}`,
  ...
  AGREEMENT_REQUEST_TRANSFER: (id) => `${BASE}/agreements/${id}/requests/transfer`,
  AGREEMENT_REQUEST_TERMINATE: (id) => `${BASE}/agreements/${id}/requests/terminate`,
  AGREEMENT_REQUEST_RESOLVE: (requestId) => `${BASE}/agreements/requests/${requestId}/resolve`,
  AGREEMENT_PENDING_ACTION_REQUESTS: `${BASE}/agreements/requests/pending`,
