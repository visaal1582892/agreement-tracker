...
import {
  ...
  TextField, Button, Chip, FormHelperText, IconButton, alpha,
} from '@mui/material';
...
export default function Step3Details({ state, updateFields, documentError, onClearDocumentError }) {
  ...
  return (
    <Box>
      <Typography variant="h6" fontWeight={600} mb={1}>Agreement Details</Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 4, pb: 3, lineHeight: 1.6, borderBottom: `1px solid ${BRAND.borderLight}` }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid size={12} sx={{ mt: 1, pt: 3 }}>
          ...
          >
            <UploadFile sx={{ fontSize: 40, color: BRAND.textSecondary, mb: 1 }} />
