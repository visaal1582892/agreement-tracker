...
export default function AgreementTypePage() {
  ...
  return (
    <Box>
      ...
      <AgreementTypeFormPanel open={page.panelOpen} onClose={page.closePanel} editingRow={page.editingRow}
        saving={page.saving} onSave={page.handleSave} />
    </Box>
  );
}

function AgreementTypeFormPanel({ open, onClose, editingRow, saving, onSave }) {
  ...
  return (
    <SlidePanel open={open} onClose={onClose} title={isEdit ? 'Edit Agreement Type' : 'Add Agreement Type'} loading={saving}>
